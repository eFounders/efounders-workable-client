...
var Jobs = {
  ...
  list: function list() {
    ...
    var endpoint = '/' + this.subdomain + '/jobs' + queryString;
  ...
  listAll: function listAll() {
    ...
    return (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
      var _ref, firstJobs, firstPaging, result, nextUrl, _ref2, jobs, paging;
  ...
  questions: function questions() {
    return _Questions2.default.new(this.subdomain, this.shortcode, this.workable);
  },
  members: function members() {
    return _Members2.default.new(this.subdomain, this.shortcode, this.workable);
  },
  recruiters: function recruiters() {
    return _Recruiters2.default.new(this.subdomain, this.shortcode, this.workable);
  },
  candidates: function candidates(id) {
    return _Candidates2.default.new(this.subdomain, this.shortcode, id, this.workable);
  }
};
